...
*/
/* Modified by Zhengting Zou, 2022/05/31, Line 1279 add " + com.npi" before " + k" so that the output of dN/dS values under FMutSel model is correct */ 
/*
#define DSDN_MC  1
   ...
   if (com.aaDist == AAClasses) {
      if (com.model == 0 || com.model == FromCodon0) {
         ...
         for (k = 0; k < com.nOmegaType; k++) {
            fprintf(fout, " %9.5f: ", x[com.ntime + com.nrgene + com.nkappa + com.npi + k]);
